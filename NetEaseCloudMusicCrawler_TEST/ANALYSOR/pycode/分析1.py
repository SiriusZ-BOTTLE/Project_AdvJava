...
print(csv_data)
csv_data=sorted(csv_data, key=lambda csv_data : csv_data[3])
# csv_data.to_csv('E:/Java高级大作业/data1', header=True, index=False)
pd.DataFrame(csv_data).to_csv("E:/Java高级大作业/data1.csv", header=['歌名','作者','专辑','评论数','歌词'], index=False, encoding='utf-8')
